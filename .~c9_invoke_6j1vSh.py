...
def add_comment():
    ...
    for com_id in com_id_arr:
        comments1.append(com_i.getText('c', com_id))
        commenters1.append(comm.getCreator('c', com_id))
...
def view_post():
    ...
    commenters1 = []
    for comm in comms:
        comments1.append(comm.getText('c', postid))
        commenters1.append(comm.getCreator('c', postid))
